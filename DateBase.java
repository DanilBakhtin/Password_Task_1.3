...
public class DateBase {
    ...
    class Row{
        ...
        public void addValue(int col, Object value){
            if (value.getClass() != cols.get(col).getType()){
                System.out.println("Не правильный класс данных!");
                return;
            }
     ...
     * @param name название колонки
     */
    public void addCol(Object type, String name){

        cols.add(new Col(name));
        cols.get(cols.size()-1).setType(type);
    }
